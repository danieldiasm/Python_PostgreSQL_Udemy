...
def create_poll(connection, title, owner, options):
    with connection:
        with connection.cursor() as cursor:
            ...
            # # The statement over with execute_values does the same of this for down below,
            # # it iterates over each tuple with the given cursor on the given query on the given tuple list.
